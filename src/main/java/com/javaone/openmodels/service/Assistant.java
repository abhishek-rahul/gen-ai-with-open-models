...
public interface Assistant {
    ...
    // [ 9. LLM / ChatModel: AiServices is a LangChain4j abstraction over the configured ChatLanguageModel. ]
    @SystemMessage("You are a helpful assistant for a Java development team.")
    String chat(@UserMessage String message);

    // [ 3. Prompt templates: variables are injected into the prompt instead of string-concatenating user input. ]
    ...
    // [ 12. Output Parsers: LangChain4j converts model output into a Java List<String> for the caller. ]
    @UserMessage("""
